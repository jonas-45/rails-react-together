...
```
git clone https://github.com/jonas-45/rails-react-together.git
```
...
Feel free to check the [issues page](https://github.com/jonas-45/rails-react-together/issues).
